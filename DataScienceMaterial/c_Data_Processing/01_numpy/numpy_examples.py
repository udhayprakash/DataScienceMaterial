...
a = a.reshape(
    (5, 2)
)  # possible reshapes will be the multiples of the total no. of elements.
print("a=", a)
print("a.shape = ", a.shape)
print(
    "Notice that reshape function creates a new array and doesn't itself modify the original array."
)
